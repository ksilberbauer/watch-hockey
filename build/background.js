...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chromePromisesJs = __webpack_require__(76);

	var timeoutId = undefined;

	function createNextWindow(prevWinId, prevParams) {
	  var prevWin, nextParams;
	  return _regeneratorRuntime.async(function createNextWindow$(context$1$0) {
	    while (1) switch (context$1$0.prev = context$1$0.next) {
	      case 0:
	        context$1$0.next = 2;
	        return _regeneratorRuntime.awrap((0, _chromePromisesJs.getWindow)(prevWinId));

	      case 2:
	        prevWin = context$1$0.sent;
	        nextParams = _extends({}, prevParams, {
	          top: prevWin.top,
	          left: prevWin.left,
	        ...
	        context$1$0.next = 6;
	        return _regeneratorRuntime.awrap((0, _chromePromisesJs.removeWindow)(prevWin.id));

	      case 6:
	        context$1$0.next = 8;
	        return _regeneratorRuntime.awrap(loop(nextParams));
	...
	var router = function router(req, sender, respond) {
	  switch (req.type) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Symbol$iterator = __webpack_require__(38)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  __webpack_require__(45)(Constructor, NAME, next);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var setUnscope = __webpack_require__(48)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(14)
	  ...
	  , species    = __webpack_require__(67)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createWindow = function createWindow(params) {
	  return new _Promise(function (resolve, reject) {
	    return chrome.windows.create(params, function (win) {
	      return resolve(win);
	    });
	  });
	};
	exports.createWindow = createWindow;
	var getWindow = function getWindow(id) {
	  return new _Promise(function (resolve, reject) {
	    return chrome.windows.get(id, null, function (win) {
	      return resolve(win);
	    });
	  });
	};
	...
	var removeWindow = function removeWindow(id) {
	  return new _Promise(function (resolve, reject) {
	    return chrome.windows.remove(id, function (id) {
	      return resolve(id);
	    });
	  });
	};
